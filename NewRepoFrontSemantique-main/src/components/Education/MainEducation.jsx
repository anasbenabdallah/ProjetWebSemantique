...
function App() {
  ...
  const handleSearchClick = async () => {
    ...
    //   });
    await axios.get(`http://localhost:8091/evenements/searchByName?nom=${search}`).then(
  ...
  const fetchAllData = async () => {
    await axios.get("http://localhost:8091/evenements/getAll").then(
      (res) => {}
    ).catch(
  ...
  const fetchSorted = async () => {
    await axios.get("http://localhost:8091/evenements/getEventsSortedByPlaces").then(
  ...
  const fetchSortedDSC = async () => {
    await axios.get("http://localhost:8091/evenements/getEventsSortedByPlacesDesc").then(
      (res) => {setSortedData(res.data)}
    ).catch(
      (error) => console.log(error)
    )
